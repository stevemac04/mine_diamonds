...
Note:
Much of this code was AI-generated by Claude using Cursor to help us debug quickly and understand many of the libraries that we had never interacted with during class. 
